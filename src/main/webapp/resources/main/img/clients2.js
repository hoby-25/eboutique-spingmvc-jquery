					...
					render : function(data){
						return "<div class='inbox status' >" + 
							"<div class='inbox-st-nav inbox-nav-mg'>"+
                                    "<button class='btn btn-info info-icon-notika' onclick='getClient("+data+")' info-icon-notika' data-toggle='modal' data-target='#myModalclient'><i class='notika-icon notika-draft'>"+
...
function updateClient(){
		$.ajax({
				...
				success: function(response){
						...
						swal("L'enregistrement a été mise à jour!", {
					      icon: "success",
					    });
					    fermerModalClient();
				}				
